//
//  InventoryItemEditInputValidator.swift
//  HomiumForIOS
//
...
class InventoryItemEditInputValidator : InputValidator{
    typealias I = (title: String, location: String, quantity : String, unit : String)
    
    //protocol functions
    func validateInput(input : (title: String, location: String, quantity : String, unit: String)) -> Bool {
